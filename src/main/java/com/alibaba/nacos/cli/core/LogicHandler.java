...
public class LogicHandler {
  ...
  public static void postConfig(String group, String dataId, String content, String type)
      throws HandlerException {
    sdkConfigService.publishConfig(dataId, group, content, type);
  }

  public static List<ConfigVO> listConfigs(
      String dataId, String group, Integer pageNo, Integer pageSize) throws HandlerException {
  ...
  public static String updateSwitch(String entry, String value, Boolean debug)
      throws HandlerException {
    String[] pair = SwitchUtils.translate(entry, value);
    return openApiService.updateSwitch(pair[0], pair[1], debug);
  }

  public static String updateSwitchMap(
      String entry, String key, String value, Boolean debug, String mode) throws HandlerException {
  ...
  public static String updateService(
      ...
      String selector)
      throws HandlerException {
    return openApiService.updateService(
        groupName, serviceName, protectThreshold, metadata, selector);
  }
  ...
  public static List<ServiceVO> listServices(
      String serviceName, String group, Integer pageNo, Integer pageSize) throws HandlerException {
  ...
  public static String addNamespace(
      String namespaceName, String customNamespaceId, String namespaceDesc)
      throws HandlerException {
    return openApiService.addNamespace(namespaceName, customNamespaceId, namespaceDesc);
  }

  public static String updateNamespace(
      String namespaceName, String customNamespaceId, String namespaceDesc)
      throws HandlerException {
  ...
  public static String updateInstance(
      ...
      Boolean ephemeral)
      throws HandlerException {
    return openApiService.updateInstance(
        ip, port, weight, enabled, metadata, clusterName, serviceName, groupName, ephemeral);
  }
