...
/**
 * @author lehr
 * Access the server by nacos http open-api
 */
public class OpenApiService {
  ...
  public List<ConfigVO> listConfigs(String dataId, String group, Integer pageNo, Integer pageSize) throws HandlerException {
  ...
  public List<ServiceVO> listService(
      String serviceName, String groupName, Integer pageNo, Integer pageSize) throws HandlerException {
  ...
  public String addNamespace(String namespaceName, String customNamespaceId, String namespaceDesc) throws HandlerException {
    Map<String, Object> params = new HashMap<>();
  ...
  public String updateNamespace(
      String namespaceName, String customNamespaceId, String namespaceDesc) throws HandlerException {
    Map<String, Object> params = new HashMap<>();
