...
public class HintUtils {
  ...
  public static final String CLI_DESCRIPTION =
      "NacosCtl is a fast, scalable, helpful client that can let you connect to nacos-server easily.";
  public static final String COMMAND_LIST_HEADING =
      "%nCommands:%n%nThe most commonly used commands are:%n";
  public static final String FOOTER =
      "%nSee 'NacosCtl help <command>' to read about a specific subcommand or concept.";
  ...
  public static final String DESCRIPTION_CLEAR =
      "Remove everything on your screen. Only JLine-Input support this function";

  public static final String NAME_QUIT = "quit";
  public static final String USAGE_QUIT = "Quit from the Cli";
  public static final String DESCRIPTION_QUIT =
      "Quit from the cli, and close the connection with current server.";
  ...
  public static final String DESCRIPTION_METRICS =
      "Nacos 0.8.0 improves the monitoring system, "
  ...
  public static final String DESCRIPTION_USE =
      "like mysql use db, you can choice default namespace so then you don't need to set namespace anymore when you send request.";
}
