...
@CommandLine.Command(
    ...
    header = "watch service/config.",
    description = "Set a listener to watch service/config changes.",
    subcommands = {CommandLine.HelpCommand.class, NacosWatchConfig.class, NacosWatchInstance.class})
