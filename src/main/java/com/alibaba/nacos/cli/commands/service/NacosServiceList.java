...
@CommandLine.Command(
    ...
    header = "list service intro",
    description =
        "Get a quick look of current services on the nacos-server. If you want to get detail about certain service, please use 'service get' command.")
public class NacosServiceList implements Runnable {

  @CommandLine.Option(
      names = {"-s", "--serviceName"},
      paramLabel = "<serviceName>",
